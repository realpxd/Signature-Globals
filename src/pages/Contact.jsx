    ...
    <div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-4 md:mb-6">Contact Us</h1>
          <p className="text-lg md:text-xl lg:text-2xl max-w-2xl">Get in touch with our team for any inquiries</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            ...
            >
              ...
              <form ref={formRefElement} onSubmit={handleSubmit} className="space-y-5 md:space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-600 focus:border-teal-600 transition-all"
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-4 bg-teal-600 text-white font-semibold rounded-lg hover:bg-teal-700 transition-all hover:scale-105"
                >
                  Send Message
                </button>
              </form>
              ...
              <div className="space-y-6 md:space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href={`tel:${COMPANY_INFO.phone.primary.replace(/\s/g, '')}`} className="text-teal-600 hover:text-teal-700 transition-colors block mb-1">
                      {COMPANY_INFO.phone.primary}
                    </a>
                    <a href={`tel:${COMPANY_INFO.phone.secondary.replace(/\s/g, '')}`} className="text-teal-600 hover:text-teal-700 transition-colors block">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${COMPANY_INFO.email}`} className="text-teal-600 hover:text-teal-700 transition-colors break-all">
                      {COMPANY_INFO.email}
                    </a>
                  </div>
                </div>
